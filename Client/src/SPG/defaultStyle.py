...
def init(gui):
    #Surface Loading
    buttonsurf = pygame.image.load('data/images/spg_art/button.png').convert_alpha()
    closesurf = pygame.image.load('data/images/spg_art/closebutton.png').convert_alpha()
    shadesurf = pygame.image.load('data/images/spg_art/shadebutton.png').convert_alpha()
    checksurf = pygame.image.load('data/images/spg_art/checkbox.png').convert_alpha()
    optionsurf = pygame.image.load('data/images/spg_art/optionbox.png').convert_alpha()
    combosurf = pygame.image.load('data/images/spg_art/combobox.png').convert_alpha()
